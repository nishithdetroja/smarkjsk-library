...
import e__default, { forwardRef, useMemo, useState, useRef, useEffect, createElement, Component, createRef, createContext, useContext, Fragment, useLayoutEffect, useCallback } from 'react';
import * as require$$1 from 'react-dom';
import require$$1__default, { findDOMNode, createPortal } from 'react-dom';
...
var CurrencyInput = forwardRef(function (_a, ref) {
    ...
    if (customInput) {
        ...
        return e__default.createElement(CustomInput, __assign({}, inputProps));
    }
    return e__default.createElement("input", __assign({}, inputProps));
});
...
var ManagerReferenceNodeContext = e.createContext();
var ManagerReferenceNodeSetterContext = e.createContext();
function Manager(_ref) {
  var children = _ref.children;

  var _React$useState = e.useState(null),
      referenceNode = _React$useState[0],
      setReferenceNode = _React$useState[1];

  var hasUnmounted = e.useRef(false);
  e.useEffect(function () {
    return function () {
      hasUnmounted.current = true;
    };
  }, []);
  var handleSetReferenceNode = e.useCallback(function (node) {
    if (!hasUnmounted.current) {
      setReferenceNode(node);
    }
  }, []);
  return /*#__PURE__*/e.createElement(ManagerReferenceNodeContext.Provider, {
    value: referenceNode
  }, /*#__PURE__*/e.createElement(ManagerReferenceNodeSetterContext.Provider, {
...
var useIsomorphicLayoutEffect = typeof window !== 'undefined' && window.document && window.document.createElement ? e.useLayoutEffect : e.useEffect;
...
var usePopper = function usePopper(referenceElement, popperElement, options) {
  ...
  var _React$useState = e.useState({
    styles: {
      popper: {
  ...
  var updateStateModifier = e.useMemo(function () {
    return {
      name: 'updateState',
      enabled: true,
      phase: 'write',
  ...
  var popperOptions = e.useMemo(function () {
    var newOptions = {
  ...
  var popperInstanceRef = e.useRef();
...
function Popper(_ref) {
  ...
  var referenceNode = e.useContext(ManagerReferenceNodeContext);

  var _React$useState = e.useState(null),
      popperElement = _React$useState[0],
      setPopperElement = _React$useState[1];

  var _React$useState2 = e.useState(null),
  ...
  var options = e.useMemo(function () {
    return {
      placement: placement,
      strategy: strategy,
  ...
  var childrenProps = e.useMemo(function () {
    return {
...
function Reference(_ref) {
  var children = _ref.children,
      innerRef = _ref.innerRef;
  var setReferenceNode = e.useContext(ManagerReferenceNodeSetterContext);
  var refHandler = e.useCallback(function (node) {
...
function requireReactInputMask_development () {
	...
	var React = _interopDefault(e__default);
	var reactDom = require$$1__default;
...
var useInsertionEffect$1 = e['useInsertion' + 'Effect'] ? e['useInsertion' + 'Effect'] : function useInsertionEffect(create) {
  create();
};
...
var useInsertionEffect = e['useInsertion' + 'Effect'] ? e['useInsertion' + 'Effect'] : useLayoutEffect;
  ...
  _createClass(Select, [{
    ...
    function renderInput() {
      ...
      if (!isSearchable) {
        ...
        return /*#__PURE__*/e.createElement(DummyInput, _extends({
          id: id,
      ...
      return /*#__PURE__*/e.createElement(Input, _extends({}, commonProps, {
        autoCapitalize: "none",
        autoComplete: "off",
        autoCorrect: "off",
        id: id,
    ...
    value: function renderPlaceholderOrValue() {
      ...
      if (!this.hasValue() || !controlShouldRenderValue) {
        return inputValue ? null : /*#__PURE__*/e.createElement(Placeholder, _extends({}, commonProps, {
          key: "placeholder",
          isDisabled: isDisabled,
          isFocused: isFocused,
          innerProps: {
      ...
      if (isMulti) {
        return selectValue.map(function (opt, index) {
          ...
          return /*#__PURE__*/e.createElement(MultiValue, _extends({}, commonProps, {
            components: {
      ...
      return /*#__PURE__*/e.createElement(SingleValue, _extends({}, commonProps, {
        data: singleValue,
        isDisabled: isDisabled
    ...
    value: function renderClearIndicator() {
      ...
      return /*#__PURE__*/e.createElement(ClearIndicator, _extends({}, commonProps, {
    ...
    value: function renderLoadingIndicator() {
      ...
      return /*#__PURE__*/e.createElement(LoadingIndicator, _extends({}, commonProps, {
        innerProps: innerProps,
        isDisabled: isDisabled,
        isFocused: isFocused
      }));
    ...
    value: function renderIndicatorSeparator() {
      ...
      var isFocused = this.state.isFocused;
      return /*#__PURE__*/e.createElement(IndicatorSeparator, _extends({}, commonProps, {
        isDisabled: isDisabled,
        isFocused: isFocused
      }));
    }
    ...
    value: function renderDropdownIndicator() {
      ...
      return /*#__PURE__*/e.createElement(DropdownIndicator, _extends({}, commonProps, {
        innerProps: innerProps,
        isDisabled: isDisabled,
        isFocused: isFocused
      }));
    ...
    value: function renderMenu() {
      ...
      var render = function render(props, id) {
        ...
        return /*#__PURE__*/e.createElement(Option, _extends({}, commonProps, {
          innerProps: innerProps,
          data: data,
          isDisabled: isDisabled,
          isSelected: isSelected,
      ...
      if (this.hasOptions()) {
        menuUI = this.getCategorizedOptions().map(function (item) {
          if (item.type === 'group') {
            ...
            return /*#__PURE__*/e.createElement(Group, _extends({}, commonProps, {
              key: groupId,
              data: _data,
              options: options,
        ...
        menuUI = /*#__PURE__*/e.createElement(LoadingMessage, commonProps, message);
      } else {
        ...
        menuUI = /*#__PURE__*/e.createElement(NoOptionsMessage, commonProps, _message);
      }
      ...
      var menuElement = /*#__PURE__*/e.createElement(MenuPlacer, _extends({}, commonProps, menuPlacementProps), function (_ref4) {
        var ref = _ref4.ref,
            _ref4$placerProps = _ref4.placerProps,
            placement = _ref4$placerProps.placement,
            maxHeight = _ref4$placerProps.maxHeight;
        return /*#__PURE__*/e.createElement(Menu, _extends({}, commonProps, menuPlacementProps, {
          innerRef: ref,
          innerProps: {
          ...
          isLoading: isLoading,
          placement: placement
        }), /*#__PURE__*/e.createElement(ScrollManager, {
          captureEnabled: captureMenuScroll,
          onTopArrive: onMenuScrollToTop,
          onBottomArrive: onMenuScrollToBottom,
          lockEnabled: menuShouldBlockScroll
        }, function (scrollTargetRef) {
          return /*#__PURE__*/e.createElement(MenuList, _extends({}, commonProps, {
      ...
      return menuPortalTarget || menuPosition === 'fixed' ? /*#__PURE__*/e.createElement(MenuPortal, _extends({}, commonProps, {
    ...
    value: function renderFormField() {
      ...
      if (isMulti) {
        if (delimiter) {
          ...
          return /*#__PURE__*/e.createElement("div", null, input);
        }
      } else {
    ...
    value: function renderLiveRegion() {
      ...
      return /*#__PURE__*/e.createElement(LiveRegion, _extends({}, commonProps, {
    ...
    value: function render() {
      ...
      return /*#__PURE__*/e.createElement(SelectContainer, _extends({}, commonProps, {
        className: className,
        innerProps: {
          id: id,
        ...
        isDisabled: isDisabled,
        isFocused: isFocused
      }), this.renderLiveRegion(), /*#__PURE__*/e.createElement(Control, _extends({}, commonProps, {
        ...
        isFocused: isFocused,
        menuIsOpen: menuIsOpen
      }), /*#__PURE__*/e.createElement(ValueContainer, _extends({}, commonProps, {
        isDisabled: isDisabled
      }), this.renderPlaceholderOrValue(), this.renderInput()), /*#__PURE__*/e.createElement(IndicatorsContainer, _extends({}, commonProps, {
        isDisabled: isDisabled
...
var StateManagedSelect = /*#__PURE__*/forwardRef(function (props, ref) {
  ...
  return /*#__PURE__*/e.createElement(Select, _extends({
    ref: ref
  }, baseSelectProps));
});
    ...
    return (e__default.createElement(e__default.Fragment, null,
        (type === 'number') ?
            e__default.createElement("div", null,
                e__default.createElement("label", { style: __assign$1(__assign$1({}, labelStyle), settings.labelStyle), htmlFor: name }, settings.label ? settings.label : 'Label'),
                e__default.createElement(CurrencyInput, { id: settings.id ? settings.id : name, name: name, tabIndex: settings.tabIndex ? settings.tabIndex : undefined, disabled: settings.disabled ? settings.disabled : false, readOnly: settings.readOnly ? settings.readOnly : false, placeholder: settings.placeholder ? settings.placeholder : '', value: (settings === null || settings === void 0 ? void 0 : settings.value) ? settings.value : undefined, className: settings === null || settings === void 0 ? void 0 : settings.className, onValueChange: onChangeEvent, style: __assign$1(__assign$1({}, inputStyle), settings.inputStyle), allowDecimals: settings.allowDecimals ? settings.allowDecimals : undefined, allowNegativeValue: settings.allowNegativeValue ? settings.allowNegativeValue : undefined, decimalsLimit: settings.decimalsLimit ? settings.decimalsLimit : undefined, decimalScale: settings.decimalScale ? settings.decimalScale : undefined, fixedDecimalLength: settings.fixedDecimalLength ? settings.fixedDecimalLength : undefined, prefix: settings.prefix ? settings.prefix : undefined, suffix: settings.suffix ? settings.suffix : undefined, decimalSeparator: settings.decimalSeparator ? settings.decimalSeparator : undefined, groupSeparator: settings.groupSeparator ? settings.groupSeparator : undefined, 
        ...
        (type === 'date') ? e__default.createElement("div", null,
            e__default.createElement("label", { style: __assign$1(__assign$1({}, labelStyle), settings.labelStyle), htmlFor: name }, settings.label ? settings.label : 'Label'),
            e__default.createElement(Wt, { id: settings.id ? settings.id : name, name: name, tabIndex: settings.tabIndex ? settings.tabIndex : undefined, placeholderText: settings.placeholder ? settings.placeholder : undefined, disabled: settings.disabled ? settings.disabled : false, readOnly: settings.readOnly ? settings.readOnly : false, selected: settings.value, dateFormat: settings.dateFormat ? settings.dateFormat : 'MM/dd/yyyy', minDate: settings.minDate ? settings.minDate : undefined, maxDate: settings.maxDate ? settings.maxDate : undefined, customInput: e__default.createElement("input", { type: "text", id: settings.id ? settings.id : name, name: name, style: __assign$1(__assign$1({}, inputStyle), settings.inputStyle) }), className: settings === null || settings === void 0 ? void 0 : settings.className, onChange: onChangeEvent, onBlur: onBlurEvent, onFocus: onFocusEvent, onKeyDown: onKeyDownEvent, ref: datepickerRef, popperClassName: settings.popperClassName ? settings.popperClassName : undefined, popperPlacement: settings.popperPlacement ? settings.popperPlacement : undefined, showTimeSelect: settings.showTimeSelect ? settings.showTimeSelect : false, showTimeSelectOnly: settings.showTimeSelectOnly ? settings.showTimeSelectOnly : false, timeIntervals: settings.timeIntervals ? settings.timeIntervals : undefined, timeCaption: settings.timeCaption ? settings.timeCaption : undefined }),
            e__default.createElement("i", { className: settings.showTimeSelectOnly ? 'fa fa-clock-o' : 'fa fa-calendar', style: __assign$1(__assign$1({}, iconStyle), settings.iconStyle), onClick: function () {
                    var datepickerElement = datepickerRef.current;
                    datepickerElement.setFocus(true);
                } })) : null,
        (type === 'mask') ? e__default.createElement("div", null,
            e__default.createElement("label", { style: __assign$1(__assign$1({}, labelStyle), settings.labelStyle), htmlFor: name }, settings.label ? settings.label : 'Label'),
            e__default.createElement(InputMask, { id: settings.id ? settings.id : name, name: name, tabIndex: settings.tabIndex ? settings.tabIndex : undefined, disabled: settings.disabled ? settings.disabled : false, readOnly: settings.readOnly ? settings.readOnly : false, placeholder: settings.placeholder ? settings.placeholder : '', mask: settings.mask ? settings.mask : '99/99/9999', maskChar: settings.maskChar ? settings.maskChar : '#', alwaysShowMask: settings.alwaysShowMask ? settings.alwaysShowMask : true, value: settings === null || settings === void 0 ? void 0 : settings.value, className: settings === null || settings === void 0 ? void 0 : settings.className, style: __assign$1(__assign$1({}, inputStyle), settings.inputStyle), onChange: onChangeEvent, onBlur: onBlurEvent, onFocus: onFocus, onKeyUp: onKeyUp, onKeyDown: onKeyDownEvent })) : null,
        (type === 'updown') ? e__default.createElement("div", null,
            e__default.createElement("label", { style: __assign$1(__assign$1({}, labelStyle), settings.labelStyle), htmlFor: name }, settings.label ? settings.label : 'Label'),
            e__default.createElement(reactNumericInput, { id: settings.id ? settings.id : name, name: name, tabIndex: settings.tabIndex ? settings.tabIndex : undefined, disabled: settings.disabled ? settings.disabled : false, readOnly: settings.readOnly ? settings.readOnly : false, placeholder: settings.placeholder ? settings.placeholder : '', value: settings === null || settings === void 0 ? void 0 : settings.value, className: settings === null || settings === void 0 ? void 0 : settings.className, style: { input: __assign$1(__assign$1({}, inputStyle), settings.inputStyle) }, min: settings.min ? settings.min : undefined, max: settings.max ? settings.max : undefined, step: settings.step ? settings.step : undefined, precision: settings.precision ? settings.precision : undefined, size: settings.size ? settings.size : undefined, onChange: onChangeEvent, onBlur: onBlurEvent, onFocus: onFocusEvent, onKeyUp: onKeyUpEvent, onKeyDown: onKeyDownEvent })) : null,
        (type === 'color') ? e__default.createElement("div", { style: { position: 'relative' } },
            e__default.createElement("label", { style: __assign$1(__assign$1({}, labelStyle), settings.labelStyle), htmlFor: name }, settings.label ? settings.label : 'Label'),
            e__default.createElement("input", { id: settings.id ? settings.id : name, name: name, tabIndex: settings.tabIndex ? settings.tabIndex : undefined, disabled: settings.disabled ? settings.disabled : false, readOnly: settings.readOnly ? settings.readOnly : false, placeholder: settings.placeholder ? settings.placeholder : '', type: "color", className: settings === null || settings === void 0 ? void 0 : settings.className, style: __assign$1(__assign$1({}, inputStyle), settings.inputStyle), value: settings.value, onChange: onChangeEvent }),
            e__default.createElement("span", { style: { paddingTop: '15px', position: 'absolute', 'left': '5px' } }, settings.value)) : null,
        (type === 'checkbox' && settings.json) ? e__default.createElement("div", { ref: checkRef },
            e__default.createElement("label", { style: __assign$1(__assign$1({}, labelStyle), settings.labelStyle), htmlFor: name }, settings.label ? settings.label : 'Label'),
            e__default.createElement("div", { style: __assign$1(__assign$1({}, inputStyle), settings.inputStyle) }, settings.json.map(function (element, i) {
                return (e__default.createElement("div", { className: "samrtjkcCheckboxbutton", key: i, style: settings.inline ? { display: 'inline-block' } : { display: 'block' } },
                    e__default.createElement("input", { type: "checkbox", className: settings.className, name: element.value, onChange: onChangeEvent, checked: element.checked, value: element.value, id: element.value }),
                    e__default.createElement("label", { style: __assign$1(__assign$1({}, checkboxLabelStyle), settings.checkboxLabelStyle), htmlFor: element.value }, element.name)));
            }))) : null,
        (type === 'radio' && settings.json) ? e__default.createElement("div", { ref: radioRef },
            e__default.createElement("label", { style: __assign$1(__assign$1({}, labelStyle), settings.labelStyle), htmlFor: name }, settings.label ? settings.label : 'Label'),
            e__default.createElement("div", { style: __assign$1(__assign$1({}, inputStyle), settings.inputStyle) }, settings.json.map(function (element, i) {
                return (e__default.createElement("div", { className: "samrtjkcradiobutton", key: i, style: settings.inline ? { display: 'inline-block' } : { display: 'block' } },
                    e__default.createElement("input", { type: "radio", className: settings.className, name: name, onChange: onChangeEvent, checked: settings.value === element.value, value: element.value, id: element.value }),
                    e__default.createElement("label", { style: __assign$1(__assign$1({}, radioLabelStyle), settings.radioLabelStyle), htmlFor: element.value }, element.name)));
            }))) : null,
        (type === 'select' && settings.json) ? e__default.createElement("div", { ref: selectRef },
            e__default.createElement("label", { style: __assign$1(__assign$1({}, labelStyle), settings.labelStyle), htmlFor: name }, settings.label ? settings.label : 'Label'),
            e__default.createElement("div", { style: __assign$1({}, settings.inputStyle) },
                e__default.createElement(StateManagedSelect, { className: 'samrtjkc-select-container', classNamePrefix: 'samrtjkc-select', placeholder: settings.placeholder, styles: selectStyle, options: settings.json }))) : null,
        (type === 'text') ? e__default.createElement("div", null,
            e__default.createElement("label", { style: __assign$1(__assign$1({}, labelStyle), settings.labelStyle), htmlFor: name }, settings.label ? settings.label : 'Label'),
            e__default.createElement("input", { id: settings.id ? settings.id : name, name: name, tabIndex: settings.tabIndex ? settings.tabIndex : undefined, disabled: settings.disabled ? settings.disabled : false, readOnly: settings.readOnly ? settings.readOnly : false, placeholder: settings.placeholder ? settings.placeholder : '', type: "text", className: settings === null || settings === void 0 ? void 0 : settings.className, style: __assign$1(__assign$1({}, inputStyle), settings.inputStyle), value: settings.value, onChange: onChangeEvent })) : null,
        (type === 'username') ? e__default.createElement("div", null,
            e__default.createElement("label", { style: __assign$1(__assign$1({}, labelStyle), settings.labelStyle), htmlFor: name }, settings.label ? settings.label : 'Label'),
            e__default.createElement("input", { id: settings.id ? settings.id : name, name: name, tabIndex: settings.tabIndex ? settings.tabIndex : undefined, disabled: settings.disabled ? settings.disabled : false, readOnly: settings.readOnly ? settings.readOnly : false, placeholder: settings.placeholder ? settings.placeholder : '', type: "text", className: settings === null || settings === void 0 ? void 0 : settings.className, style: __assign$1(__assign$1({}, inputStyle), settings.inputStyle), value: settings.value, maxLength: settings.maxLength ? settings.maxLength : undefined, minLength: settings.minLength ? settings.minLength : undefined, onChange: onChangeEvent }),
            settings.iconShow &&
                e__default.createElement("i", { className: settings.iconClass ? settings.iconClass : 'fa fa-user', style: __assign$1(__assign$1({}, iconStyle), settings.iconStyle) })) : null,
        (type === 'password') ? e__default.createElement("div", null,
            e__default.createElement("label", { style: __assign$1(__assign$1({}, labelStyle), settings.labelStyle), htmlFor: name }, settings.label ? settings.label : 'Label'),
            e__default.createElement("input", { id: settings.id ? settings.id : name, name: name, tabIndex: settings.tabIndex ? settings.tabIndex : undefined, disabled: settings.disabled ? settings.disabled : false, readOnly: settings.readOnly ? settings.readOnly : false, placeholder: settings.placeholder ? settings.placeholder : '', type: settings.isShowPassword ? 'text' : 'password', className: settings === null || settings === void 0 ? void 0 : settings.className, style: __assign$1(__assign$1({}, inputStyle), settings.inputStyle), maxLength: settings.maxLength ? settings.maxLength : undefined, minLength: settings.minLength ? settings.minLength : undefined, value: settings.value, onChange: onChangeEvent }),
            settings.iconShowHideToggle &&
                e__default.createElement("i", { className: settings.isShowPassword ? 'fa fa-eye-slash' : 'fa fa-eye', onClick: function () { onClickEvent(!settings.isShowPassword); }, style: __assign$1(__assign$1({}, iconToggleStyle), settings.iconToggleStyle) }),
            settings.iconShow &&
                e__default.createElement("i", { className: settings.iconClass ? settings.iconClass : 'fa fa-key', style: __assign$1(__assign$1({}, iconStyle), settings.iconStyle) })) : null));
};
