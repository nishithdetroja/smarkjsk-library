...
var CurrencyInput = e.forwardRef(function (_a, ref) {
    ...
    var localeConfig = e.useMemo(function () { return getLocaleConfig(intlConfig); }, [intlConfig]);
    ...
    var formattedStateValue = defaultValue !== undefined && defaultValue !== null
        ...
        : userValue !== undefined && userValue !== null
            ...
            : '';
    var _g = e.useState(formattedStateValue), stateValue = _g[0], setStateValue = _g[1];
    var _h = e.useState(false), dirty = _h[0], setDirty = _h[1];
    var _j = e.useState(0), cursor = _j[0], setCursor = _j[1];
    var _k = e.useState(0), changeCount = _k[0], setChangeCount = _k[1];
    var _l = e.useState(null), lastKeyStroke = _l[0], setLastKeyStroke = _l[1];
    var inputRef = ref || e.useRef(null);
    /**
    ...
    var handleOnBlur = function (event) {
        ...
        var valueOnly = cleanValue$1(__assign({ value: value }, cleanValueOptions));
    ...
    var handleOnKeyDown = function (event) {
        ...
        if (step && (key === 'ArrowUp' || key === 'ArrowDown')) {
            ...
            var currentValue = parseFloat(userValue !== undefined && userValue !== null
                ...
                : cleanValue$1(__assign({ value: stateValue }, cleanValueOptions))) || 0;
    ...
    if (customInput) {
        ...
        return e__default["default"].createElement(CustomInput, __assign({}, inputProps));
    }
    return e__default["default"].createElement("input", __assign({}, inputProps));
});
...
function Reference(_ref) {
  ...
  e__namespace.useEffect(function () {
    warningExports(Boolean(setReferenceNode), '`Reference` should not be used outside of a `Manager` component.');
  }, [setReferenceNode]);
...
var css_248z$4 = ".react-datepicker-popper{\r\n    width: max-content;\r\n}\r\n.react-datepicker-popper[data-placement^=bottom] .react-datepicker__triangle{\r\n    transform: translate(70px, 0px) !important;\r\n}";
styleInject(css_248z$4);

var css_248z$3 = "input[type=\"color\"]::-webkit-color-swatch-wrapper {\r\n    padding: 5px 0px 5px 0px;\r\n    width: 20px;\r\n    float: right;\r\n}";
styleInject(css_248z$3);

var css_248z$2 = ":scope {\r\n    --smartjkc-checkbox-pointer-color : #3EB489;\r\n    --smartjkc-checkbox-pointer-width: 5px;\r\n    --smartjkc-checkbox-pointer-height: 10px;\r\n    --smartjkc-checkbox-pointer-margin: 1px 5px;\r\n    --smartjkc-checkbox-checked-border-color: #3EB489;\r\n    --smartjkc-checkbox-unchecked-border-color: gray;\r\n    --smartjkc-checkbox-checked-bg-color: #ffffff;\r\n    --smartjkc-checkbox-unchecked-bg-color: #ffffff;\r\n    --smartjkc-checkbox-border: 1px solid;\r\n    --smartjkc-checkbox-border-radius: 2px;\r\n    --smartjkc-checkbox-height: 14px;\r\n    --smartjkc-checkbox-width: 14px;\r\n  }\r\n\r\n.samrtjkcCheckboxbutton input[type=checkbox] {\r\n      vertical-align: middle;\r\n      position: relative;\r\n      box-sizing: content-box;\r\n      top:1px;\r\n      width: var(--smartjkc-checkbox-width);\r\n      height: var(--smartjkc-checkbox-height);\r\n      cursor: pointer;\r\n      border-radius: var(--smartjkc-checkbox-border-radius);\r\n      background-color: var(--smartjkc-checkbox-unchecked-bg-color);\r\n      -webkit-appearance: none;\r\n      border: var(--smartjkc-checkbox-border) var(--smartjkc-checkbox-unchecked-border-color);\r\n}\r\n\r\n.samrtjkcCheckboxbutton  [type=\"checkbox\"]::before {\r\n    content: '';\r\n    display: block;\r\n}\r\n.samrtjkcCheckboxbutton  [type=\"checkbox\"]:checked{\r\n    border-color: var(--smartjkc-checkbox-checked-border-color);\r\n    background-color: var(--smartjkc-checkbox-checked-bg-color);\r\n}\r\n.samrtjkcCheckboxbutton  [type=\"checkbox\"]:checked::before { \r\n    width: var(--smartjkc-checkbox-pointer-width);\r\n    height: var(--smartjkc-checkbox-pointer-height);\r\n    margin: var(--smartjkc-checkbox-pointer-margin);\r\n    border-bottom: 2px solid var(--smartjkc-checkbox-pointer-color);\r\n    border-right: 2px solid var(--smartjkc-checkbox-pointer-color);\r\n    transform: rotate(45deg);\r\n}";
styleInject(css_248z$2);

var css_248z$1 = ":root {\r\n  --smartjkc-radio-checked-color: #3EB489;\r\n  --smartjkc-radio-checked-border-color: #3EB489;\r\n  --smartjkc-radio-unchecked-border-color: gray;\r\n  --smartjkc-radio-border: 1px solid;\r\n  --smartjkc-radio-height: 14px;\r\n  --smartjkc-radio-width: 14px;\r\n}\r\n\r\n.samrtjkcradiobutton input[type=radio] {\r\n  vertical-align: middle;\r\n  visibility: hidden;\r\n}\r\n\r\n.samrtjkcradiobutton  [type=\"radio\"]::before {\r\n  border: var(--smartjkc-radio-border);\r\n  border-color: var(--smartjkc-radio-unchecked-border-color);\r\n  height: var(--smartjkc-radio-height);\r\n  width: var(--smartjkc-radio-width);\r\n  border-radius: 50%;\r\n  display: block;\r\n  content: \" \";\r\n  cursor: pointer;\r\n  visibility: visible;\r\n}\r\n\r\n.samrtjkcradiobutton  [type=\"radio\"]:checked::before { \r\n  border: var(--smartjkc-radio-border);\r\n  border-color: var(--smartjkc-radio-checked-border-color);\r\n  height: var(--smartjkc-radio-height);\r\n  width: var(--smartjkc-radio-width);\r\n  border-radius: 50%;\r\n  display: block;\r\n  content: \" \";\r\n  cursor: pointer;\r\n  visibility: visible;\r\n  background: radial-gradient( var(--smartjkc-radio-checked-color) 35%, transparent 50%);\r\n} ";
styleInject(css_248z$1);

var css_248z = ".samrtjkc-select__control:hover {\r\n    border-color: inherit !important;\r\n}";
...
function requireReactInputMask_development () {
	...
	var React = _interopDefault(e__default["default"]);
...
/***/ (function(module, exports) {
	...
	module.exports = e__default["default"];
...
var EmotionCacheContext = /* #__PURE__ */e.createContext( // we're doing this to avoid preconstruct's dead code elimination in this one case
...
var withEmotionCache = function withEmotionCache(func) {
  // $FlowFixMe
  return /*#__PURE__*/e.forwardRef(function (props, ref) {
    // the cache will never be null in the browser
    var cache = e.useContext(EmotionCacheContext);
  ...
  withEmotionCache = function withEmotionCache(func) {
    return function (props) {
      ...
      if (cache === null) {
        ...
        return /*#__PURE__*/e.createElement(EmotionCacheContext.Provider, {
          value: cache
        }, func(props, cache));
      } else {
...
var ThemeContext = /* #__PURE__ */e.createContext({});
...
var useInsertionEffect$1 = e__namespace['useInsertion' + 'Effect'] ? e__namespace['useInsertion' + 'Effect'] : function useInsertionEffect(create) {
  create();
};
...
var Emotion = /* #__PURE__ */withEmotionCache(function (props, cache, ref) {
  ...
  var serialized = serializeStyles(registeredStyles, undefined, e.useContext(ThemeContext));
  ...
  return /*#__PURE__*/e.createElement(e.Fragment, null, /*#__PURE__*/e.createElement(Insertion$1, {
    cache: cache,
    serialized: serialized,
    isStringTag: typeof WrappedComponent === 'string'
  }), /*#__PURE__*/e.createElement(WrappedComponent, newProps));
});
...
var useInsertionEffect = e__namespace['useInsertion' + 'Effect'] ? e__namespace['useInsertion' + 'Effect'] : e.useLayoutEffect;
...
var Global = /* #__PURE__ */withEmotionCache(function (props, cache) {
  ...
  var serialized = serializeStyles([styles], undefined, e.useContext(ThemeContext));
  ...
  if (!isBrowser$1) {
    ...
    return /*#__PURE__*/e.createElement("style", (_ref = {}, _ref["data-emotion"] = cache.key + "-global " + serializedNames, _ref.dangerouslySetInnerHTML = {
      __html: rules
...
var Insertion = function Insertion(_ref) {
  ...
  if (!isBrowser$1 && rules.length !== 0) {
    ...
    return /*#__PURE__*/e.createElement("style", (_ref2 = {}, _ref2["data-emotion"] = cache.key + " " + serializedArr.map(function (serialized) {
...
var ClassNames = /* #__PURE__ */withEmotionCache(function (props, cache) {
  ...
  var content = {
    css: css,
    cx: cx,
    theme: e.useContext(ThemeContext)
  };
...
var PortalPlacementContext = /*#__PURE__*/e.createContext({
...
var MenuPortal = /*#__PURE__*/function (_Component2) {
  ...
  _createClass(MenuPortal, [{
    ...
    value: function render() {
      ...
      }, appendTo ? /*#__PURE__*/require$$1.createPortal(menuWrapper, appendTo) : menuWrapper);
    }
  }]);
...
function useStateManager(_ref) {
  ...
  var _useState = e.useState(propsInputValue !== undefined ? propsInputValue : defaultInputValue),
      _useState2 = _slicedToArray(_useState, 2),
      stateInputValue = _useState2[0],
      setStateInputValue = _useState2[1];

  var _useState3 = e.useState(propsMenuIsOpen !== undefined ? propsMenuIsOpen : defaultMenuIsOpen),
      _useState4 = _slicedToArray(_useState3, 2),
      stateMenuIsOpen = _useState4[0],
      setStateMenuIsOpen = _useState4[1];

  var _useState5 = e.useState(propsValue !== undefined ? propsValue : defaultValue),
      _useState6 = _slicedToArray(_useState5, 2),
      stateValue = _useState6[0],
      setStateValue = _useState6[1];

  var onChange = e.useCallback(function (value, actionMeta) {
  ...
  var onInputChange = e.useCallback(function (value, actionMeta) {
    var newValue;
  ...
  var onMenuOpen = e.useCallback(function () {
  ...
  var onMenuClose = e.useCallback(function () {
...
var LiveRegion = function LiveRegion(props) {
  ...
  var messages = e.useMemo(function () {
    return _objectSpread2(_objectSpread2({}, defaultAriaLiveMessages), ariaLiveMessages || {});
  }, [ariaLiveMessages]); // Update aria live selected option when prop changes

  var ariaSelected = e.useMemo(function () {
    var message = '';
  ...
  var ariaFocused = e.useMemo(function () {
    var focusMsg = '';
  ...
  var ariaResults = e.useMemo(function () {
    var resultsMsg = '';
  ...
  var ariaGuidance = e.useMemo(function () {
    var guidanceMsg = '';
  ...
  var ScreenReaderText = jsx(e.Fragment, null, jsx("span", {
    id: "aria-selection"
  }, ariaSelected), jsx("span", {
    id: "aria-context"
  }, ariaContext));
  var isInitialFocus = (ariaSelection === null || ariaSelection === void 0 ? void 0 : ariaSelection.action) === 'initial-input-focus';
  return jsx(e.Fragment, null, jsx(A11yText, {
    id: id
...
function useScrollCapture(_ref) {
  ...
  var isBottom = e.useRef(false);
  var isTop = e.useRef(false);
  var touchStart = e.useRef(0);
  var scrollTarget = e.useRef(null);
  var handleEventDelta = e.useCallback(function (event, delta) {
  ...
  var onWheel = e.useCallback(function (event) {
    handleEventDelta(event, event.deltaY);
  }, [handleEventDelta]);
  var onTouchStart = e.useCallback(function (event) {
    // set touch start so we can calculate touchmove delta
    touchStart.current = event.changedTouches[0].clientY;
  }, []);
  var onTouchMove = e.useCallback(function (event) {
    var deltaY = touchStart.current - event.changedTouches[0].clientY;
    handleEventDelta(event, deltaY);
  }, [handleEventDelta]);
  var startListening = e.useCallback(function (el) {
  ...
  var stopListening = e.useCallback(function (el) {
...
function useScrollLock(_ref) {
  ...
  var originalStyles = e.useRef({});
  var scrollTarget = e.useRef(null);
  var addScrollLock = e.useCallback(function (touchScrollTarget) {
    if (!canUseDOM) return;
  ...
  var removeScrollLock = e.useCallback(function (touchScrollTarget) {
    if (!canUseDOM) return;
    var target = document.body;
...
function ScrollManager(_ref) {
  ...
  return jsx(e.Fragment, null, lockEnabled && jsx("div", {
...
var Select = /*#__PURE__*/function (_Component) {
  ...
  _createClass(Select, [{
    ...
    value: function renderLiveRegion() {
      ...
      return /*#__PURE__*/e__namespace.createElement(LiveRegion, _extends({}, commonProps, {
...
var StateManagedSelect = /*#__PURE__*/e.forwardRef(function (props, ref) {
...
var JkcInput = function (props) {
    var type = props.type, name = props.name, settings = props.settings, onChangeEvent = props.onChangeEvent, onBlurEvent = props.onBlurEvent, onFocusEvent = props.onFocusEvent, onKeyUpEvent = props.onKeyUpEvent, onKeyDownEvent = props.onKeyDownEvent, onClickEvent = props.onClickEvent;
    var datepickerRef = e.useRef(null);
    var selectRef = e.useRef();
    var checkRef = e.useRef();
    var radioRef = e.useRef();
    var labelStyle = {
        marginBottom: '0px',
        position: 'absolute',
        paddingLeft: '6px',
    ...
    var selectStyle = {
        control: function (provided, state) {
            return __assign$1(__assign$1(__assign$1({}, provided), { color: state.isFocused ? '#3eb489' : '#3eb489' }), customControlStyles);
        }
    };
    if (type === 'number') {
    ...
    return (e__default["default"].createElement(e__default["default"].Fragment, null,
        (type === 'number') ?
            e__default["default"].createElement("div", null,
                e__default["default"].createElement("label", { style: __assign$1(__assign$1({}, labelStyle), settings.labelStyle), htmlFor: name }, settings.label ? settings.label : 'Label'),
                e__default["default"].createElement(CurrencyInput, { id: settings.id ? settings.id : name, name: name, tabIndex: settings.tabIndex ? settings.tabIndex : undefined, disabled: settings.disabled ? settings.disabled : false, readOnly: settings.readOnly ? settings.readOnly : false, placeholder: settings.placeholder ? settings.placeholder : '', value: (settings === null || settings === void 0 ? void 0 : settings.value) ? settings.value : undefined, className: settings === null || settings === void 0 ? void 0 : settings.className, onValueChange: onChangeEvent, style: __assign$1(__assign$1({}, inputStyle), settings.inputStyle), allowDecimals: settings.allowDecimals ? settings.allowDecimals : undefined, allowNegativeValue: settings.allowNegativeValue ? settings.allowNegativeValue : undefined, decimalsLimit: settings.decimalsLimit ? settings.decimalsLimit : undefined, decimalScale: settings.decimalScale ? settings.decimalScale : undefined, fixedDecimalLength: settings.fixedDecimalLength ? settings.fixedDecimalLength : undefined, prefix: settings.prefix ? settings.prefix : undefined, suffix: settings.suffix ? settings.suffix : undefined, decimalSeparator: settings.decimalSeparator ? settings.decimalSeparator : undefined, groupSeparator: settings.groupSeparator ? settings.groupSeparator : undefined, 
                    // intlConfig = {settings.intlConfig ? settings.intlConfig : {}}
                    disableAbbreviations: settings.disableAbbreviations ? settings.disableAbbreviations : undefined, disableGroupSeparators: settings.disableGroupSeparators ? settings.disableGroupSeparators : undefined, maxLength: settings.maxLength ? settings.maxLength : undefined, step: settings.step ? settings.step : undefined, onBlur: onBlurEvent, onFocus: onFocus, onKeyUp: onKeyUpEvent, onKeyDown: onKeyDownEvent })) : null,
        (type === 'date') ? e__default["default"].createElement("div", null,
            e__default["default"].createElement("label", { style: __assign$1(__assign$1({}, labelStyle), settings.labelStyle), htmlFor: name }, settings.label ? settings.label : 'Label'),
            e__default["default"].createElement(Wt, { id: settings.id ? settings.id : name, name: name, tabIndex: settings.tabIndex ? settings.tabIndex : undefined, placeholderText: settings.placeholder ? settings.placeholder : undefined, disabled: settings.disabled ? settings.disabled : false, readOnly: settings.readOnly ? settings.readOnly : false, selected: settings.value, dateFormat: settings.dateFormat ? settings.dateFormat : 'MM/dd/yyyy', minDate: settings.minDate ? settings.minDate : undefined, maxDate: settings.maxDate ? settings.maxDate : undefined, customInput: e__default["default"].createElement("input", { type: "text", id: settings.id ? settings.id : name, name: name, style: __assign$1(__assign$1({}, inputStyle), settings.inputStyle) }), className: settings === null || settings === void 0 ? void 0 : settings.className, onChange: onChangeEvent, onBlur: onBlurEvent, onFocus: onFocusEvent, onKeyDown: onKeyDownEvent, ref: datepickerRef, popperClassName: settings.popperClassName ? settings.popperClassName : undefined, popperPlacement: settings.popperPlacement ? settings.popperPlacement : undefined, showTimeSelect: settings.showTimeSelect ? settings.showTimeSelect : false, showTimeSelectOnly: settings.showTimeSelectOnly ? settings.showTimeSelectOnly : false, timeIntervals: settings.timeIntervals ? settings.timeIntervals : undefined, timeCaption: settings.timeCaption ? settings.timeCaption : undefined }),
            e__default["default"].createElement("i", { className: settings.showTimeSelectOnly ? 'fa fa-clock-o' : 'fa fa-calendar', style: __assign$1(__assign$1({}, iconStyle), settings.iconStyle), onClick: function () {
                    var datepickerElement = datepickerRef.current;
                    datepickerElement.setFocus(true);
                } })) : null,
        (type === 'mask') ? e__default["default"].createElement("div", null,
            e__default["default"].createElement("label", { style: __assign$1(__assign$1({}, labelStyle), settings.labelStyle), htmlFor: name }, settings.label ? settings.label : 'Label'),
            e__default["default"].createElement(InputMask, { id: settings.id ? settings.id : name, name: name, tabIndex: settings.tabIndex ? settings.tabIndex : undefined, disabled: settings.disabled ? settings.disabled : false, readOnly: settings.readOnly ? settings.readOnly : false, placeholder: settings.placeholder ? settings.placeholder : '', mask: settings.mask ? settings.mask : '99/99/9999', maskChar: settings.maskChar ? settings.maskChar : '#', alwaysShowMask: settings.alwaysShowMask ? settings.alwaysShowMask : true, value: settings === null || settings === void 0 ? void 0 : settings.value, className: settings === null || settings === void 0 ? void 0 : settings.className, style: __assign$1(__assign$1({}, inputStyle), settings.inputStyle), onChange: onChangeEvent, onBlur: onBlurEvent, onFocus: onFocus, onKeyUp: onKeyUp, onKeyDown: onKeyDownEvent })) : null,
        (type === 'updown') ? e__default["default"].createElement("div", null,
            e__default["default"].createElement("label", { style: __assign$1(__assign$1({}, labelStyle), settings.labelStyle), htmlFor: name }, settings.label ? settings.label : 'Label'),
            e__default["default"].createElement(reactNumericInput, { id: settings.id ? settings.id : name, name: name, tabIndex: settings.tabIndex ? settings.tabIndex : undefined, disabled: settings.disabled ? settings.disabled : false, readOnly: settings.readOnly ? settings.readOnly : false, placeholder: settings.placeholder ? settings.placeholder : '', value: settings === null || settings === void 0 ? void 0 : settings.value, className: settings === null || settings === void 0 ? void 0 : settings.className, style: { input: __assign$1(__assign$1({}, inputStyle), settings.inputStyle) }, min: settings.min ? settings.min : undefined, max: settings.max ? settings.max : undefined, step: settings.step ? settings.step : undefined, precision: settings.precision ? settings.precision : undefined, size: settings.size ? settings.size : undefined, onChange: onChangeEvent, onBlur: onBlurEvent, onFocus: onFocusEvent, onKeyUp: onKeyUpEvent, onKeyDown: onKeyDownEvent })) : null,
        (type === 'color') ? e__default["default"].createElement("div", { style: { position: 'relative' } },
            e__default["default"].createElement("label", { style: __assign$1(__assign$1({}, labelStyle), settings.labelStyle), htmlFor: name }, settings.label ? settings.label : 'Label'),
            e__default["default"].createElement("input", { id: settings.id ? settings.id : name, name: name, tabIndex: settings.tabIndex ? settings.tabIndex : undefined, disabled: settings.disabled ? settings.disabled : false, readOnly: settings.readOnly ? settings.readOnly : false, placeholder: settings.placeholder ? settings.placeholder : '', type: "color", className: settings === null || settings === void 0 ? void 0 : settings.className, style: __assign$1(__assign$1({}, inputStyle), settings.inputStyle), value: settings.value, onChange: onChangeEvent }),
            e__default["default"].createElement("span", { style: { paddingTop: '15px', position: 'absolute', 'left': '5px' } }, settings.value)) : null,
        (type === 'checkbox' && settings.json) ? e__default["default"].createElement("div", { ref: checkRef },
            e__default["default"].createElement("label", { style: __assign$1(__assign$1({}, labelStyle), settings.labelStyle), htmlFor: name }, settings.label ? settings.label : 'Label'),
            e__default["default"].createElement("div", { style: __assign$1(__assign$1({}, inputStyle), settings.inputStyle) }, settings.json.map(function (element, i) {
                return (e__default["default"].createElement("div", { className: "samrtjkcCheckboxbutton", key: i, style: settings.inline ? { display: 'inline-block' } : { display: 'block' } },
                    e__default["default"].createElement("input", { type: "checkbox", className: settings.className, name: element.value, onChange: onChangeEvent, checked: element.checked, value: element.value, id: element.value }),
                    e__default["default"].createElement("label", { style: __assign$1(__assign$1({}, checkboxLabelStyle), settings.checkboxLabelStyle), htmlFor: element.value }, element.name)));
            }))) : null,
        (type === 'radio' && settings.json) ? e__default["default"].createElement("div", { ref: radioRef },
            e__default["default"].createElement("label", { style: __assign$1(__assign$1({}, labelStyle), settings.labelStyle), htmlFor: name }, settings.label ? settings.label : 'Label'),
            e__default["default"].createElement("div", { style: __assign$1(__assign$1({}, inputStyle), settings.inputStyle) }, settings.json.map(function (element, i) {
                return (e__default["default"].createElement("div", { className: "samrtjkcradiobutton", key: i, style: settings.inline ? { display: 'inline-block' } : { display: 'block' } },
                    e__default["default"].createElement("input", { type: "radio", className: settings.className, name: name, onChange: onChangeEvent, checked: settings.value === element.value, value: element.value, id: element.value }),
                    e__default["default"].createElement("label", { style: __assign$1(__assign$1({}, radioLabelStyle), settings.radioLabelStyle), htmlFor: element.value }, element.name)));
            }))) : null,
        (type === 'select' && settings.json) ? e__default["default"].createElement("div", { ref: selectRef },
            e__default["default"].createElement("label", { style: __assign$1(__assign$1({}, labelStyle), settings.labelStyle), htmlFor: name }, settings.label ? settings.label : 'Label'),
            e__default["default"].createElement("div", { style: __assign$1({}, settings.inputStyle) },
                e__default["default"].createElement(StateManagedSelect, { className: 'samrtjkc-select-container', classNamePrefix: 'samrtjkc-select', placeholder: settings.placeholder, styles: selectStyle, options: settings.json }))) : null,
        (type === 'text') ? e__default["default"].createElement("div", null,
            e__default["default"].createElement("label", { style: __assign$1(__assign$1({}, labelStyle), settings.labelStyle), htmlFor: name }, settings.label ? settings.label : 'Label'),
            e__default["default"].createElement("input", { id: settings.id ? settings.id : name, name: name, tabIndex: settings.tabIndex ? settings.tabIndex : undefined, disabled: settings.disabled ? settings.disabled : false, readOnly: settings.readOnly ? settings.readOnly : false, placeholder: settings.placeholder ? settings.placeholder : '', type: "text", className: settings === null || settings === void 0 ? void 0 : settings.className, style: __assign$1(__assign$1({}, inputStyle), settings.inputStyle), value: settings.value, onChange: onChangeEvent })) : null,
        (type === 'username') ? e__default["default"].createElement("div", null,
            e__default["default"].createElement("label", { style: __assign$1(__assign$1({}, labelStyle), settings.labelStyle), htmlFor: name }, settings.label ? settings.label : 'Label'),
            e__default["default"].createElement("input", { id: settings.id ? settings.id : name, name: name, tabIndex: settings.tabIndex ? settings.tabIndex : undefined, disabled: settings.disabled ? settings.disabled : false, readOnly: settings.readOnly ? settings.readOnly : false, placeholder: settings.placeholder ? settings.placeholder : '', type: "text", className: settings === null || settings === void 0 ? void 0 : settings.className, style: __assign$1(__assign$1({}, inputStyle), settings.inputStyle), value: settings.value, maxLength: settings.maxLength ? settings.maxLength : undefined, minLength: settings.minLength ? settings.minLength : undefined, onChange: onChangeEvent }),
            settings.iconShow &&
                e__default["default"].createElement("i", { className: settings.iconClass ? settings.iconClass : 'fa fa-user', style: __assign$1(__assign$1({}, iconStyle), settings.iconStyle) })) : null,
        (type === 'password') ? e__default["default"].createElement("div", null,
            e__default["default"].createElement("label", { style: __assign$1(__assign$1({}, labelStyle), settings.labelStyle), htmlFor: name }, settings.label ? settings.label : 'Label'),
            e__default["default"].createElement("input", { id: settings.id ? settings.id : name, name: name, tabIndex: settings.tabIndex ? settings.tabIndex : undefined, disabled: settings.disabled ? settings.disabled : false, readOnly: settings.readOnly ? settings.readOnly : false, placeholder: settings.placeholder ? settings.placeholder : '', type: settings.isShowPassword ? 'text' : 'password', className: settings === null || settings === void 0 ? void 0 : settings.className, style: __assign$1(__assign$1({}, inputStyle), settings.inputStyle), maxLength: settings.maxLength ? settings.maxLength : undefined, minLength: settings.minLength ? settings.minLength : undefined, value: settings.value, onChange: onChangeEvent }),
            settings.iconShowHideToggle &&
                e__default["default"].createElement("i", { className: settings.isShowPassword ? 'fa fa-eye-slash' : 'fa fa-eye', onClick: function () { onClickEvent(!settings.isShowPassword); }, style: __assign$1(__assign$1({}, iconToggleStyle), settings.iconToggleStyle) }),
            settings.iconShow &&
                e__default["default"].createElement("i", { className: settings.iconClass ? settings.iconClass : 'fa fa-key', style: __assign$1(__assign$1({}, iconStyle), settings.iconStyle) })) : null));
};

exports.JkcInput = JkcInput;
